...
forcew = [['ULK1', 'ATG13', 2],
          ...
          ['FOXO3', 'SOD2', 2],
          ['TSC2', 'RHEB', 2],
          ['Glycolysis', 'TCA cycle', 2]]#index and value of weight I want to manually adjust;['node1', 'node2', 1]
forceb = [['ATG13', -1],
          ['ATG5', -1],
          ['ATM/ATR_2', -1],
          ['INSR', 1],
          ...
          ['SOD2', -1],
          ['RHEB', 1],
          ['TCA cycle', -1]]#index and value of basal activity I want to manually adjust;['node1', 1]
