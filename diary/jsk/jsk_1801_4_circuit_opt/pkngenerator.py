...
'''
This code generates numerous potential PKN_20 based on core PKN_20 and extravagant PKN_20 
'''
#declare necessary constants
maxlinkno = 2#maximum number of links to add

#import network information
corenetdata = []#list with core network information
corenetfile = open('pkn_20_core.sif', 'r')
for link in corenetfile:
    corenetdata.append(link.strip().split('\t'))
extranetdata = []#list with extravagant network information
extranetfile = open('pkn_20_extra.sif', 'r')
