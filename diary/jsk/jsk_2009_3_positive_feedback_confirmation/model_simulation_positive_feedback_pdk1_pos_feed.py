...
for positive_feedback_network_only in [False, True]:
    for pos_feed_cut in [False, True]:
        ...
        if positive_feedback_network_only:
            netparams_str = '_positive_feedback_network_only'
        else:
            netparams_str = ''
        if pos_feed_cut:
        ...
        all_df.to_csv('results/simulation_result_pos_feed_{}{}.csv'.format(pos_feed_cut_str, netparams_str))
        attractor_avg_new_df.to_csv('results/average_attractor_pos_feed_{}{}.csv'.format(pos_feed_cut_str, netparams_str))
        ...
        for _ipt_cond, _attractor_df_new in zip(["{0:b}".format(i).zfill(3) for i in range(2**3)], attractor_df_new_list):
            _attractor_df_new.to_csv('results/attractor_res_raw_{}_{}_{}_{}_{}_{}_{}{}.csv'.format(iptnodes[0], _ipt_cond[0], iptnodes[1], _ipt_cond[1], iptnodes[2], _ipt_cond[2], pos_feed_cut_str, netparams_str))
