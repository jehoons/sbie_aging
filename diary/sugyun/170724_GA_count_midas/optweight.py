...
class OptWeight(base):
    ...
    def __init__(self, dim = 9, i_dim=9):  # num of link 13(weight) + 11(basal)
        ...
        for train_graph in J['train_graph']:
            self.train_data.append([train_graph['before'].encode("ascii"), train_graph['pert'], train_graph['state'], train_graph['after'].encode("ascii")])
        # print('train',self.train_data)
        # set the bounds
