...
% save('basal.mat','Basal')
% save('Relation.mat','Relation')
load('Relation.mat');
load('basal.mat');
node_names =  {'ABL1', 'AKT1', 'AMPK', 'ATG13', 'ATG5', 'ATM/ATR', 'ATM/ATR_2', 'BAX', 'BCL2', 'CASP3', 'CASP9', 'CDK4', 'CDKN1A', 'CDKN2A', 'DNAdamage', 'DNAdamage_high', 'E2F1', 'EIF4EBP1', 'FOXO3', 'HIPK2', 'IGF1', 'IGF1R', 'IKBKB', 'IL1B', 'IL6', 'IRS1', 'MAP2K3/MAP2K6', 'MAPK14', 'MDM2', 'MTOR', 'NAD+', 'NFKB1', 'NFKBIE', 'PDK1', 'PIK3CA', 'PPARGC1A', 'PTEN', 'RB1', 'RHEB', 'ROS', 'S6K1', 'SGK1', 'SIRT1', 'SOD2', 'TNF', 'TP53', 'TP53_s46', 'TSC2', 'ULK1', 'lowNutrition'}
...
%15 dna,16 dna_high, 21 IGF, 50 nutrition
X_index = 15,21;
...
constraints = struct( ...
    'index', {15,21}, ... % node
    'range', {[0,100],[99,100]} ... % ranged constraint of each node
);
