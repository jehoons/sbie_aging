...
fc = pd.read_csv('test.txt',sep="\t",header=None)
raw = pd.read_csv('raw.txt',sep="\t",header=None)
...
result = pd.DataFrame(np.zeros((col_count,col_count)))
