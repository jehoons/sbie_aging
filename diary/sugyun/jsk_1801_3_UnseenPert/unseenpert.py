...
intrapa = intdatas[1]
mtorabs = ['mTOR (Ab-2448)', 'mTOR (Ab-2481)', 'mTOR (Phospho-Ser2448)', 'mTOR (Phospho-Thr2446)', 'mTOR (Phospho-Ser2481)', 'mTOR (Ab-2446)']
mtorabidx = [ablist.index(ab) for ab in ablist if ab in mtorabs]
predrapaR = seneR
for mab in mtorabidx:
    predrapaR[:][mab] = 0
#print('validation of predicted rapamycin R to rapamycin, quiescence, and senescence data')
#print(calcRerr(predrapaR, intrapa))
#print(calcRerr(predrapaR, intqui))
#print(calcRerr(predrapaR, intsene))
#validating R with a random shuffled R matrix
valR = seneR
np.random.shuffle(valR)
#print('validation using random shuffle of seneR')
#print(calcRerr(valR, intsene))
#print(calcRerr(valR, intqui))
#print(calcRerr(valR, intrapa))
