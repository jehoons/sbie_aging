...
iptidx = []#input basal activity node index
netfile = open('PKN_20_1.sif', 'r')
for link in netfile:
...
class OptWeightandBasal(base):
    ...
    def __init__(self, dim = 1, i_dim = 1, netdata = netdata, conddata = conddata, iptidx = iptidx):
